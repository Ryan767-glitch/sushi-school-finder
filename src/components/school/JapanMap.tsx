...
// Prefecture outlines based on Geolonia japanese-prefectures (GFDL)
...
const MAP_REGIONS: { id: RegionId; short: string; x: string; y: string }[] = [
  ...
  { id: "kanto", short: "関東", x: "63%", y: "58%" },
  { id: "koshinetsu", short: "甲信越・北陸", x: "50%", y: "56%" },
  { id: "tokai", short: "東海", x: "52%", y: "69%" },
  { id: "kansai", short: "関西", x: "41%", y: "71%" },
  { id: "chugoku-shikoku", short: "中国・四国", x: "30%", y: "64%" },
...
export function JapanMap() {
  ...
  const counts = useMemo(() => {
    ...
    for (const s of schools) c[s.region] = (c[s.region] || 0) + 1;
    return c;
  }, []);

  const list = regionMeta.filter((r) => r.id !== "all");

  const labelOf = (id: string) => {
    const meta = regionMeta.find((r) => r.id === id);
    const n = counts[id] || 0;
    return `${meta?.label ?? id}（${n}校）`;
  };
  ...
  const regionClass = (id: string) =>
    [
      "japan-region",
      `japan-region--${id}`,
      hovered === id ? "is-active" : "",
      hovered && hovered !== id ? "is-dim" : "",
    ]
      .filter(Boolean)
      .join(" ");

  return (
    <div className="grid lg:grid-cols-[minmax(0,1fr)_260px] gap-6 items-center">
      <div className="relative rounded-2xl bg-gradient-to-b from-[#eef4ff] to-[#f7f9fd] border border-line overflow-hidden mx-auto w-full max-w-[560px]">
        <svg
          viewBox="0 0 1000 1000"
          className="japan-map-svg block w-full h-auto"
          role="img"
          aria-labelledby="japan-map-title"
        >
      ...
      <Link
        ...
        onFocus={() => setHovered("hokkaido-tohoku")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("hokkaido-tohoku")}
        className={regionClass("hokkaido-tohoku")}
      >
        <g>
        <g className="pref pref-fukushima" transform="translate(594.000000, 511.000000)">
        ...
        <g className="pref pref-yamagata" transform="translate(612.000000, 439.000000)">
        ...
        <g className="pref pref-akita" transform="translate(617.000000, 352.000000)">
        ...
        <g className="pref pref-miyagi" transform="translate(648.000000, 445.000000)">
        ...
        <g className="pref pref-iwate" transform="translate(664.000000, 354.000000)">
        ...
        <g className="pref pref-aomori" transform="translate(624.000000, 287.000000)">
        ...
        <g className="pref pref-hokkaido" transform="translate(602.000000, 10.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("kanto")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("kanto")}
        className={regionClass("kanto")}
      >
        <g>
        <g className="pref pref-kanagawa" transform="translate(584.000000, 656.000000)">
        ...
        <g className="pref pref-tokyo" transform="translate(585.000000, 642.000000)">
        ...
        <g className="pref pref-chiba" transform="translate(627.000000, 629.000000)">
        ...
        <g className="pref pref-saitama" transform="translate(573.000000, 618.000000)">
        ...
        <g className="pref pref-gunma" transform="translate(557.000000, 570.000000)">
        ...
        <g className="pref pref-tochigi" transform="translate(603.000000, 563.000000)">
        ...
        <g className="pref pref-ibaraki" transform="translate(622.000000, 575.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("koshinetsu")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("koshinetsu")}
        className={regionClass("koshinetsu")}
      >
        <g>
        <g className="pref pref-nagano" transform="translate(503.000000, 572.000000)">
        ...
        <g className="pref pref-yamanashi" transform="translate(546.000000, 638.000000)">
        ...
        <g className="pref pref-fukui" transform="translate(408.000000, 618.000000)">
        ...
        <g className="pref pref-ishikawa" transform="translate(448.000000, 541.000000)">
        ...
        <g className="pref pref-toyama" transform="translate(475.000000, 575.000000)">
        ...
        <g className="pref pref-niigata" transform="translate(518.000000, 476.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("tokai")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("tokai")}
        className={regionClass("tokai")}
      >
        <g>
        <g className="pref pref-mie" transform="translate(426.000000, 683.000000)">
        ...
        <g className="pref pref-aichi" transform="translate(469.000000, 673.000000)">
        ...
        <g className="pref pref-shizuoka" transform="translate(511.000000, 659.000000)">
        ...
        <g className="pref pref-gifu" transform="translate(450.000000, 608.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("kansai")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("kansai")}
        className={regionClass("kansai")}
      >
        <g>
        <g className="pref pref-wakayama" transform="translate(385.000000, 737.000000)">
        ...
        <g className="pref pref-nara" transform="translate(410.000000, 712.000000)">
        ...
        <g className="pref pref-hyogo" transform="translate(345.000000, 655.000000)">
        ...
        <g className="pref pref-osaka" transform="translate(387.000000, 695.000000)">
        ...
        <g className="pref pref-kyoto" transform="translate(377.000000, 649.000000)">
        ...
        <g className="pref pref-shiga" transform="translate(423.000000, 655.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("chugoku-shikoku")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("chugoku-shikoku")}
        className={regionClass("chugoku-shikoku")}
      >
        <g>
        <g className="pref pref-kochi" transform="translate(251.000000, 765.000000)">
        ...
        <g className="pref pref-ehime" transform="translate(225.000000, 737.000000)">
        ...
        <g className="pref pref-kagawa" transform="translate(308.000000, 724.000000)">
        ...
        <g className="pref pref-tokushima" transform="translate(312.000000, 744.000000)">
        ...
        <g className="pref pref-yamaguchi" transform="translate(168.000000, 710.000000)">
        ...
        <g className="pref pref-hiroshima" transform="translate(230.000000, 687.000000)">
        ...
        <g className="pref pref-okayama" transform="translate(295.000000, 673.000000)">
        ...
        <g className="pref pref-shimane" transform="translate(211.000000, 610.000000)">
        ...
        <g className="pref pref-tottori" transform="translate(288.000000, 658.000000)">
      ...
      <Link
        ...
        onMouseLeave={() => setHovered(null)}
        onFocus={() => setHovered("kyushu-okinawa")}
        onBlur={() => setHovered(null)}
        aria-label={labelOf("kyushu-okinawa")}
        className={regionClass("kyushu-okinawa")}
      >
        <g>
        <g className="pref pref-okinawa" transform="translate(52.000000, 193.000000)">
        ...
        <g className="pref pref-kagoshima" transform="translate(96.000000, 17.000000)">
        ...
        <g className="pref pref-miyazaki" transform="translate(152.000000, 824.000000)">
        ...
        <g className="pref pref-oita" transform="translate(163.000000, 771.000000)">
        ...
        <g className="pref pref-kumamoto" transform="translate(115.000000, 800.000000)">
        ...
        <g className="pref pref-nagasaki" transform="translate(44.000000, 700.000000)">
        ...
        <g className="pref pref-saga" transform="translate(108.000000, 773.000000)">
        ...
        <g className="pref pref-fukuoka" transform="translate(123.000000, 752.000000)">
        ...
        {MAP_REGIONS.map((r) => (
          <span
            key={r.id}
            className={`pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 text-[10px] md:text-[11px] font-extrabold tracking-wide px-2 py-0.5 rounded-full shadow-sm border whitespace-nowrap ${
              hovered === r.id
                ? "bg-coral text-white border-coral"
                : "bg-white/95 text-navy border-white"
            }`}
      ...
      <ul className="grid grid-cols-2 lg:grid-cols-1 gap-2 content-start">
        {list.map((r) => {
          ...
          return (
            <li key={r.id}>
              <Link
                ...
                onMouseEnter={() => setHovered(r.id as RegionId)}
                onMouseLeave={() => setHovered(null)}
                onFocus={() => setHovered(r.id as RegionId)}
                onBlur={() => setHovered(null)}
                className={`flex items-center justify-between gap-3 rounded-xl border px-3.5 py-3 transition-colors ${
                  active
                    ? "border-coral bg-coral text-white"
                    : "border-line bg-white hover:border-blue hover:bg-soft-blue"
                }`}
              >
                <span>
